      ...
      >
        ...
        >
          {isSubmitting ? 
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="-ml-px"><polyline points="9 10 4 15 9 20"></polyline><path d="M20 4v7a4 4 0 0 1-4 4H4"></path>
            </svg>
          }
        </button>
...
const App = () => (
  ...
  >
    ...
    <p className="text-sm text-gray-400 mb-6">This shows how secrets are removed or masked when entered in an input field.</p>
    <SecureForm />
